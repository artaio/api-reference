defmodule DocsWeb.Schemas.Response.CollectionTagRule do
  ...
  OpenApiSpex.schema(%{
    ...
    properties: %{
      ...
      organization_tag_id: %Schema{
        type: :uuid,
        description:
          "The ID of the OrganizationTag this rule applies to. If provided, the rule will only apply to shipments with this tag.",
        example: "f7e4b35b-5131-47c2-9a88-238bd6e62e2e"
      },
      created_at: %Schema{
        type: :string,
        format: "date-time",
    ...
    example: %{
      ...
      "organization_tag_id" => "f7e4b35b-5131-47c2-9a88-238bd6e62e2d",
      "pattern" => "seller-a-*",
