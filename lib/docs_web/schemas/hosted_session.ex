  ...
  OpenApiSpex.schema(%{
    ...
    properties: %{
      additional_services: %Schema{
        type: :array,
        description: "Any desired services, such as unpacking, installation, etc. can be sent through in the request and will be treated as if that requested service is required. Requested services may disqualify certain segments of shipping services offered by Arta depending on location and object details.",
        items: %Schema{
          type: :string,
      ...
      internal_reference: %Schema{
        type: :string,
        description: "This field can be used to pass through any data about the request you may want returned unaltered for your own later usage",
        maxLength: 255,
        nullable: true
      },
      origin: Location,
      ...
      private_token: %Schema{
        type: :string,
        description: "A private access token for this resource. It is used to generate the private URL for the hosted session"
      },
      ...
      preferred_quote_types: %Schema{
        type: :array,
        description: "An optional field presenting the list of quote types the caller instructed Arta to return as part of the hosted session",
        items: %Schema{
          type: :string
        }
      },
